...
import com.example.gappa.databinding.ActivitySignInBinding;
...
public class SignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful())
                        {
                            ...
                            //System.out.println("Main activity Intent start");
                            Intent intent = new Intent(SignInActivity.this,MainActivity.class);
                            startActivity(intent);
                           // System.out.println("Main activity Intent End");
                            finish();
        ...
        binding.signInAlreadyUser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            startActivity(intent);
                            finish();
                            Toast.makeText(SignInActivity.this, "Google In Successful", Toast.LENGTH_SHORT).show();
                        } else {
